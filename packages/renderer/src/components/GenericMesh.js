import { BoxGeometry, EdgesGeometry, MeshStandardMaterial, LineBasicMaterial, Mesh, LineSegments, Color, } from 'three';
...
export class GenericMesh extends ComponentMesh {
    ...
    _build() {
        ...
        const height = 0.30;
        const depth = 0.50;
        const category = CATEGORY_MAP[type] ?? 'generic';
    ...
    setPosition(board) {
        ...
        this.group.position.set((p1.x + p2.x) / 2, p1.y, p1.z);
    }
}
//# sourceMappingURL=GenericMesh.js.map