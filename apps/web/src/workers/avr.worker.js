...
import { CPU, AVRIOPort, AVRUSART, AVRTimer, portBConfig, portCConfig, portDConfig, timer0Config, timer1Config, timer2Config, usart0Config, AVRADC, adcConfig, PinState } from 'avr8js';
...
export class AvrWorker {
    ...
    adc = null;
    running = false;
    pinStates = { digital: {}, analog: {}, pwm: {} };
    onPinChangeCallback = null;
    onSerialCallback = null;
    loadSketch(hex) {
    ...
    setPinInput(pin, value) {
        if (!this.portB || !this.portC || !this.portD)
            return;
...
//# sourceMappingURL=avr.worker.js.map