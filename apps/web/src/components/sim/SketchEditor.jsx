...
export function SketchEditor(props) {
    ...
    const [selectedHex, setSelectedHex] = createSignal(Object.keys(PRECOMPILED_SKETCHES)[0]);
    ...
    onMount(() => {
        ...
        const updateSerial = (newLines) => setLines([...newLines]);
        ...
        <div class="sketch-modal" onClick={(e) => e.stopPropagation()}>
          <div class="sketch-header">
            ...
            <div class="sketch-actions">
              <select class="sketch-select" value={selectedHex()} onInput={(e) => setSelectedHex(e.currentTarget.value)}>
          ...
          <div class="sketch-body">
            <div class="editor-area">
              <textarea class="sketch-textarea" value={sketch()} onInput={(e) => setSketch(e.currentTarget.value)} spellcheck={false}/>
            </div>
...
//# sourceMappingURL=SketchEditor.jsx.map