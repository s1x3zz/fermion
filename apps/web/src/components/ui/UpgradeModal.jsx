...
export function UpgradeModal(props) {
    ...
    return (<Portal mount={document.body}>
      <div class="modal-backdrop" onClick={props.onClose}>
        <div class="modal-box" onClick={(e) => e.stopPropagation()} style={{ padding: '28px', 'max-width': '480px', width: '100%' }}>
          <h2 style={{ margin: '0 0 8px' }}>Upgrade Your Plan</h2>
          <p style={{ margin: '0 0 20px', color: '#aaa' }}>
            You're currently on the{' '}
            <strong>{TIER_LIMITS[tier()]?.label ?? 'Free'}</strong> plan.
          ...
          <div style={{ display: 'flex', gap: '12px', 'margin-bottom': '20px' }}>
            ...
            gap: '8px',
              ...
              <button class="auth-submit" style={{ 'margin-top': 'auto', padding: '8px 16px', background: '#1976d2' }} disabled={loading() !== null} onClick={() => void handleUpgrade('pro')}>
            ...
            gap: '8px',
              ...
              <button class="auth-submit" style={{ 'margin-top': 'auto', padding: '8px 16px', background: '#43a047' }} disabled={loading() !== null} onClick={() => void handleUpgrade('ultimate')}>
          ...
          <div style={{ 'text-align': 'center' }}>
            <button class="auth-submit" style={{ width: 'auto', padding: '8px 20px', background: '#333' }} onClick={props.onClose}>
              Maybe Later
            </button>
          </div>
        </div>
...
//# sourceMappingURL=UpgradeModal.jsx.map