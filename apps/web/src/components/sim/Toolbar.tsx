...
export function Toolbar(props: ToolbarProps) {
  ...
  function handleReset() {
    if (sim.isSimulating()) sim.toggleSimulate()
  }

  function handleViewPreset(view: 'front' | 'side' | 'top') {
  ...
  return (
    <div class="sim-toolbar">
      ...
      <div class="toolbar-section">
        ...
        <div class="toolbar-project-name">
          <input
            ...
            type="text"
            value={projectName()}
            size={Math.max(12, projectName().length + 2)}
      ...
      <div class="toolbar-section toolbar-section-center">
        <button
          class={`toolbar-btn-simulate${sim.isSimulating() ? ' active' : ''}`}
