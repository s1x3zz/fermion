      ...
      <div class="nav-inner l-inner">
        ...
        <div class="nav-actions">
          <Show when={auth.user()} fallback={<>
                <button class="btn btn-outline btn-sm" onClick={props.onOpenModal}>
                  Log in
                </button>
...
function PreviewFrame() {
    ...
    return (<section class="preview-wrap">
      <div class="l-inner">
        <div ref={frameRef} class="preview-frame" style={{ 'box-shadow': `0 24px 80px 16px rgba(59, 139, 255, ${glowOpacity()})` }}>
    ...
    return (<section class="section" id="pricing">
      <div class="l-inner">
        ...
        <div class="pricing-grid">
          <For each={PLANS}>
            {(plan) => (<div class={`pricing-card${plan.featured ? ' featured' : ''}`}>
                ...
                <div class="plan-cta">
                  <button class={`btn ${plan.featured ? 'btn-primary' : 'btn-outline'}`} onClick={props.onOpenModal}>
                    {plan.cta}
                  </button>
                </div>
              </div>)}
...
export function Landing() {
    ...
    return (<>
      ...
      <Show when={showModal()}>
        <AuthModal onClose={closeModal} {...(searchParams.error !== undefined ? { initialError: searchParams.error } : {})}/>
      </Show>
    </>);
}
